...
return {
  ...
  -- directory is a git repo.
  {
    ...
    keys = {
      ...
      -- find
      {
        k.picker_find_buffers,
        "<cmd>Telescope buffers sort_mru=true sort_lastused=true ignore_current_buffer=true<cr>",
        desc = "Buffers",
      },
      { k.picker_find_buffers_all, "<cmd>Telescope buffers<cr>", desc = "Buffers (all)" },
      ...
      { k.picker_git_commits_alt, "<cmd>Telescope git_commits<CR>", desc = "Commits" },
      { k.picker_git_status, "<cmd>Telescope git_status<CR>", desc = "Status" },
      { k.picker_git_stash, "<cmd>Telescope git_stash<cr>", desc = "Git Stash" },
      -- search
      { k.picker_search_registers, "<cmd>Telescope registers<cr>", desc = "Registers" },
      { k.picker_search_history, "<cmd>Telescope search_history<cr>", desc = "Search History" },
      { k.picker_search_autocommands, "<cmd>Telescope autocommands<cr>", desc = "Auto Commands" },
      { k.picker_search_buffer, "<cmd>Telescope current_buffer_fuzzy_find<cr>", desc = "Buffer Lines" },
      ...
      { k.picker_search_document_diagnostics, "<cmd>Telescope diagnostics<cr>", desc = "Diagnostics" },
      { k.picker_search_workspace_diagnostics, "<cmd>Telescope diagnostics bufnr=0<cr>", desc = "Buffer Diagnostics" },
      ...
      { k.picker_search_word_cwd, LazyVim.pick("grep_string", { root = false, word_match = "-w" }), desc = "Word (cwd)" },
      { k.picker_search_selection_root, LazyVim.pick("grep_string"), mode = "x", desc = "Selection (Root Dir)" },
      { k.picker_search_selection_cwd, LazyVim.pick("grep_string", { root = false }), mode = "x", desc = "Selection (cwd)" },
      { k.picker_colorscheme_preview, LazyVim.pick("colorscheme", { enable_preview = true }), desc = "Colorscheme with Preview" },
      {
