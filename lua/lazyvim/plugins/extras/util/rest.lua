...
return {
  {
    ...
    keys = {
      ...
      { k.kulala_open_scratchpad, "<cmd>lua require('kulala').scratchpad()<cr>", desc = "Open scratchpad" },
      ...
      { k.kulala_set_env, "<cmd>lua require('kulala').set_selected_env()<cr>", desc = "Set environment", ft = "http" },
      {
      ...
      { k.kulala_jump_to_next_request, "<cmd>lua require('kulala').jump_next()<cr>", desc = "Jump to next request", ft = "http" },
      { k.kulala_jump_to_previous_request, "<cmd>lua require('kulala').jump_prev()<cr>", desc = "Jump to previous request", ft = "http" },
      { k.kulala_close, "<cmd>lua require('kulala').close()<cr>", desc = "Close window", ft = "http" },
      { k.kulala_replay, "<cmd>lua require('kulala').replay()<cr>", desc = "Replay the last request" },
      ...
      { k.kulala_toggle_view, "<cmd>lua require('kulala').toggle_view()<cr>", desc = "Toggle headers/body", ft = "http" },
    },
    opts = {},
  },
  {
