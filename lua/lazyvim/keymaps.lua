...
M.default_keymaps = {
  ...
  toggle_dim = "<leader>uD",
  toggle_animate = "<leader>ua",
  toggle_indent = "<leader>ug",
  ...
  picker_find_buffers_all = "<leader>fB",
  ...
  picker_git_diff = "<leader>gd",
  picker_git_commits_alt = "<leader>gl",
  picker_git_status = "<leader>gs",
  picker_git_stash = "<leader>gS",
  picker_search_registers = '<leader>s"',
  picker_search_history = "<leader>s/",
  ...
  octo_assignee = "<localleader>a",
  octo_comment_code = "<localleader>c",
  octo_label = "<localleader>l",
  octo_issue = "<localleader>i",
  octo_react = "<localleader>r",
  octo_pr = "<localleader>p",
  octo_rebase = "<localleader>pr",
  octo_squash = "<localleader>ps",
  octo_review = "<localleader>v",
